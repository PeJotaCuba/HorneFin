...
export const TRANSLATIONS = {
  ES: {
    ...
    uploadFile: "Sube un archivo .txt",
    aiIdentify: "La IA identificará los ingredientes",
  ...
  EN: {
    ...
    uploadFile: "Upload a .txt file",
    aiIdentify: "AI will identify ingredients",
    analyzing: "AI Analyzing Recipe...",
  ...
  PT: {
    ...
    aiIdentify: "IA identificará os ingredientes",
    analyzing: "IA Analisando Receita...",
